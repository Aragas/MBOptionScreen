...
namespace MBOptionScreen.FileDatabase
{
    ...
    internal class DefaultFileStorage : IFileStorage
    {
        ...
        public Dictionary<Type, Dictionary<string, ISerializeableFile>> Data { get; } = new Dictionary<Type, Dictionary<string, ISerializeableFile>>();
        ...
        public T Get<T>(string id) where T : ISerializeableFile
        {
        ...
        private void Add(ISerializeableFile loadable)
        {
            if (loadable == null)
